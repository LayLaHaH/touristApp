      ...
      SingleChildScrollView(
        physics: BouncingScrollPhysics(),
          child: Column(
            children:  <Widget>[
              SizedBox(height: 10,),
              LeftSideAddress(title:'Activities', fontSize: 20.0,),
                SizedBox(
                  height: 540,
                            ...
                            width: 330,
                              ...
                              children: [
                                ...
                                Positioned(
                                  ...
                                  left: 60,
                                  width: 230,
                                  child: cardText(label: "Oppening days : " , description: "from ${snapshot.data![index].startingDay?.day} to ${snapshot.data![index].startingDay?.day}")
                                ),                     
                                Positioned(
                                  top: 120,
                                  left: 60,
