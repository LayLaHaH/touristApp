...
class _SingleGovState extends State<SingleGov> {
  ...
  final response = await http.get(Uri.parse('$baseUrl/Governorate/governorates/$id/restaurants'));
  ...
  final response = await http.get(Uri.parse('$baseUrl/Governorate/governorates/$id/hotels'));
